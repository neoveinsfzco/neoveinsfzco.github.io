// src/pages/DocumentBuilderPage.tsx
...
import { NqmDocumentEditor } from '../components/NqmDocumentEditor';
...
export function DocumentBuilderPage({
  ...
  const [htmlContent, setHtmlContent] = useState(
    '<h1>New Document</h1><p>Start writing your controlled document here...</p>',
  );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Created document via builder', result);
      setSuccessOpen(true);

      // Optionally clear / keep for editing template
      setTitle('');
      setCategoryId('');
      setTypeId('');
      setChangeSummary('');
      ...
      console.error('Error creating document from builder', err);
      setError(
